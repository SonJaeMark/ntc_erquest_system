...
public class PaymentController {
    ...
    @PutMapping("/confirm-payment/{documentRequestId}")
    public ResponseEntity<PaymentResponseDTO> confirmPayment(@PathVariable Long documentRequestId){
        return ResponseEntity.ok(paymentService.confirmPayment(documentRequestId));
    }
}
